//------------------------------------------------------------------------------
// <copyright file="MoveLinesDown.cs" company="Company">
...
namespace EclipseKey
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class MoveLinesDown
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MoveLinesDown"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        private MoveLinesDown(Package package)
        {
            if (package == null)
            {
        ...
        /// </summary>
        public static MoveLinesDown Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new MoveLinesDown(package);
        }
        ...
        private void MenuItemCallback(object sender, EventArgs e)
        {
            ...
            dte.BeginUpdate("move lines down");

            selection.Delete();

            selection.MoveTo(lineno + 1, 1);
