//------------------------------------------------------------------------------
// <copyright file="MoveLinesUp.cs" company="Company">
...
namespace EclipseKey
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class MoveLinesUp
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MoveLinesUp"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        private MoveLinesUp(Package package)
        {
            if (package == null)
            {
        ...
        /// </summary>
        public static MoveLinesUp Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new MoveLinesUp(package);
        }
        ...
        private void MenuItemCallback(object sender, EventArgs e)
        {
            ...
            dte.BeginUpdate("move lines up");

            selection.Delete();

            selection.MoveTo(lineno - 1, 1, false);
